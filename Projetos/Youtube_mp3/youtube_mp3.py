...
def baixar_musica(url, destino):
    try:
        ...
        if True or False:
            print("""
Verifique o destino escolhido e confira seu download.
""")

# Diretório onde você deseja salvar o arquivo MP3
destino = input(""" 
Olá seja bem vindo (a) ao Youtube_mp3
                
Para começar digite o destino onde o arquivo será salvo 
...
""")
    ...
    if url.lower() == "sair":
        print("""
Agradecemos por utilizar o programa. 
Até mais!
              """)
        break
